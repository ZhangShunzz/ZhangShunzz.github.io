...
![redis01]({{ '/styles/images/redis/redis01.png' | prepend: site.baseurl  }})
...
![redis02]({{ '/styles/images/redis/redis02.png' | prepend: site.baseurl  }})
...
![redis03]({{ '/styles/images/redis/redis03.png' | prepend: site.baseurl  }})
...
![redis04]({{ '/styles/images/redis/redis04.png' | prepend: site.baseurl  }})
...
![redis05]({{ '/styles/images/redis/redis05.png' | prepend: site.baseurl  }})
...
![redis06]({{ '/styles/images/redis/redis06.png' | prepend: site.baseurl  }})
